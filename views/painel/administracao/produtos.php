                        ...
                        ?>
                            <div class="card col-xl-3">
                                ...
                                <div class="card-body pl-0 pr-0">
                                    <h3 class="card-title m-0 p-0"><?=$produtos['nomeProduto'];?></h3>
                                    <?php
...
<div class="card-footer pl-0 pr-0">
    <button class="btn btn-default float-left btn-block btn-sm" data-toggle="modal" data-target="#edita-produto" data-id="<?=$produtos['idProduto']?>">Editar/Definir Preços</button>
        <div class="row">
            <div class="col-md-6">
                                ...
                                <div class="card bg-secondary border-0 mb-0">
                                    ...
                                    <div class="card-body px-lg-5 py-lg-5">
                                        <ul class="nav nav-pills mb-5" id="pills-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active mb-3" id="pills-dados-tab" data-toggle="pill" href="#pills-dados" role="tab" aria-controls="pills-dados" aria-selected="true">Dados</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mb-3" id="pills-precorevenda-tab" data-toggle="pill" href="#pills-precorevenda" role="tab" aria-controls="pills-precorevenda" aria-selected="false">Preço Revenda</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mb-3" id="pills-precofinal-tab" data-toggle="pill" href="#pills-precofinal" role="tab" aria-controls="pills-precofinal" aria-selected="false">Preço Final</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mb-3" id="pills-foto-tab" data-toggle="pill" href="#pills-foto" role="tab" aria-controls="pills-foto" aria-selected="false">Nova Foto</a>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="tab-pane fade" id="pills-foto" role="tabpanel" aria-labelledby="pills-foto-tab">
                                                <form role="form">
                                                    <div class="row" id="cortaImagemEdicao">
                                                        <input type="hidden" class="d-none" id="idProdutoImagem" value="<?=$produtos['idProduto']?>">
                                                        <div class="col-md-12 text-center">
                                                            <div id="upload-demo-edicao"></div>
                                                        </div>
                                                        <div class="col-md-12" style="padding:5%;">
                                                            <input type="file" id="image-edicao" class="d-none">
                                                            <label for="image-edicao" class="p-3 border text-center"><strong class="text-primary">Clique aqui</strong> e escolha uma imagem para seu produto</label>
                                                            <button type="button" class="btn btn-default btn-block btn-upload-image-edicao mt-4" style="margin-top:2%">Mudar Foto do Produto</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
